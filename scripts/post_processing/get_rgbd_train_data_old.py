...
def get_rgbd_tuples(filepath, stereo_ckpt, batch_size=16):
    ...
    return left_rgb_im_traj, right_rgb_im_traj, tri_depth_im_traj, serial_numbers, frame_counts[0], cam_matrices, rand_idxs
...
if __name__ == "__main__":
    ...
    save_path = "/mnt/fsx/ashwinbalakrishna/datasets/narrow_debugging_old_dataloader"
    ...
    for i, traj_name in enumerate(sorted(os.listdir(r2d2_data_path))):
        ...
        left_rgb_im_traj, right_rgb_im_traj, tri_depth_im_traj, serial_numbers, frame_count, cam_matrices, rand_idxs = get_rgbd_tuples(svo_path, stereo_ckpt)
